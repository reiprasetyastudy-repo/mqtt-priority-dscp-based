...
# ==========================================
# Topology: 1 switch, 3 hosts (h1, h2, h3)
# Filtering: IP-based (10.0.0.1 = anomaly, 10.0.0.2 = normal)
...
SCENARIO_NAME="01-single-switch-3hosts"
...
echo "=========================================="
echo "Topology: Single Switch with 3 Hosts"
echo "  - h1 (10.0.0.1): Publisher Anomaly"
echo "  - h2 (10.0.0.2): Publisher Normal"
echo "  - h3 (10.0.0.3): Broker + Subscriber"
echo "  - s1: OpenFlow 1.3 Switch"
echo ""
echo "Filtering Method: IP-based"
echo "  - Anomaly traffic (10.0.0.1) → Queue 1, Priority 20"
echo "  - Normal traffic (10.0.0.2)  → Queue 2, Priority 10"
echo ""
