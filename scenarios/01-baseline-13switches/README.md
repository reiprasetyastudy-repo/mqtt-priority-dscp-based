# Scenario 06: DSCP-Based QoS (13 Switches - Hierarchical 3-Tier)

## Overview

This scenario combines the **hierarchical 3-tier topology** from Scenario 02 with the **DSCP-based QoS approach** from Scenario 05, providing 5 priority levels across a complex multi-layer network.
...
- **Bandwidth:** 0.5 Mbps per link (creates high congestion)
- **Message Rate:** 50 msg/s per publisher
- **Total Load:** 18 publishers × 50 msg/s = 900 msg/s
- **Network Utilization:** ~216% (highly congested for testing)

### Results Location

Results are saved to timestamped directories:
```
/home/mqtt-sdn/results/06-dscp-qos-13switches/run_YYYY-MM-DD_HH-MM-SS/
...
├── topology_config.py              # 13-switch hierarchical topology
