#!/bin/bash
###############################################################################
# Run Full Experiment - Scenario 07 DSCP QoS (13 Switches - Core Bottleneck)
#
...
echo "=============================================================="
echo "  SCENARIO 07: DSCP-Based QoS (13 Switches - Core Bottleneck)"
echo "=============================================================="
echo ""
echo "Topology: Hierarchical 3-Tier with Core Bottleneck"
echo "  - Core (s1) links: 0.5 Mbps (BOTTLENECK)"
echo "  - Other links: 10 Mbps"
...
RUN_RESULTS_DIR="$PROJECT_ROOT/results/07-dscp-qos-13switches-core-bottleneck/run_$TIMESTAMP"
...
{
    echo "=============================================================="
    echo "  SCENARIO 07: DSCP QoS - Core Bottleneck (13 Switches)"
    echo "=============================================================="
    echo ""
    echo "Topology: Hierarchical 3-Tier (Core: 0.5 Mbps, Others: 10 Mbps)"
