#!/bin/bash
# ==========================================
# Scenario 05: DSCP-Based Priority (7 Switches)
# ==========================================
# DSCP tagging approach - Publisher set DSCP di IP header
...
echo "=========================================="
echo "Topology: DSCP-Based Priority"
...
echo ""
echo "Priority Mechanism: DSCP Tagging"
echo "  - Publisher SET DSCP di IP header"
echo "  - Anomaly: DSCP 46 (Expedited Forwarding) → Queue 1"
echo "  - Normal:  DSCP 0  (Best Effort) → Queue 2"
echo "  - Controller match DSCP → Set Queue"
echo ""
