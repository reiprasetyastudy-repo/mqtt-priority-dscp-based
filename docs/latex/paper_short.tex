...
\textbf{Efektivitas}: Mekanisme HTB queue dengan alokasi bandwidth 60-80\% untuk Queue 1 efektif melindungi traffic prioritas. Pada kondisi congestion 1.8x kapasitas, traffic anomaly tetap terkirim dengan delay minimal dan tanpa packet loss.

\textbf{Skalabilitas}: Performa pada topologi 17 switches hampir identik dengan 13 switches, menunjukkan skalabilitas yang baik.

\textbf{Ketahanan}: Pada kondisi lossy, delay meningkat 58\% namun reliabilitas tetap terjaga. Pada kondisi failure, degradasi terjadi namun prioritas tetap dipertahankan.
...
Penelitian ini memvalidasi kerangka kerja QoS berbasis DSCP untuk prioritas traffic MQTT pada SDN. Hasil eksperimen menunjukkan: (1) traffic anomaly mendapatkan delay 212-338 ms dan packet loss 0\% pada kondisi normal, (2) mekanisme efektif pada topologi dengan redundansi, dan (3) prioritas tetap dipertahankan pada kondisi failure. Kontribusi meliputi implementasi DSCP marking transparan, integrasi SDN controller, dan validasi pada empat skenario berbeda.
