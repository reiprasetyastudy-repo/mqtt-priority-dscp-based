...
\item Mengisi gap penelitian yang belum mengeksplorasi DSCP standar untuk prioritas trafik MQTT pada jaringan SDN, penelitian ini melakukan evaluasi komprehensif pada dua skenario topologi dengan kondisi congestion realistis untuk menunjukkan efektivitas dan skalabilitas framework pada deployment berskala besar.
\end{enumerate}
...
\caption{Topologi Jaringan Dual-Core (14 Switches)}
\label{fig:topo2}
\end{figure}

Pengujian dilakukan dalam dua skenario. Skenario pertama menguji operasi normal dengan kedua core aktif. Skenario kedua mensimulasikan kegagalan core dengan dua fase: fase pertama sebagai baseline dengan kondisi normal, dan fase kedua dengan core switch s2 dinonaktifkan sehingga semua traffic melewati s1 saja.
...
\section{Results}
% TODO: Hasil eksperimen akan ditambahkan setelah pengujian selesai

\section{Discussion}
% TODO: Analisis dan diskusi akan ditambahkan setelah hasil tersedia

\section{Conclusion}
% TODO: Kesimpulan akan ditambahkan setelah analisis selesai
